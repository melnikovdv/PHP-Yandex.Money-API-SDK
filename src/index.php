    ...
    <body>
        <div id="main">        		
            ...
            <p>
                ...
                <p>
                    <b>Внимание: </b> затем нужно полученный Идентификатор приложения скопировать в файл consts.php 
                ...
                аккаунт) разрешения на доступ вашего приложения к его эккаунту. Это разрешение представляет собой 
